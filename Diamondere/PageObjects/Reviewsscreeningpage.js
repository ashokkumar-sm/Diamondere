...
class reviewscreening{
   ...
   get txtreviewtitleandcommentsfirstrow(){
     ...
     selectViewallRings(){
      ...
      BrowserUtil.wait(5);
      browser.switchWindow(data.Reviewsscreening.DiamondereRingsReviewURL)
   }

     movetofreeglobal(){
      ElementUtil.scrollIntoView(this.sctnfreeGlobalshippingpage3,"Move down to the free global section in page 3")
     }
